...
import (
	...
	"github.com/d-kononov/saml2aws/v2/cmd/saml2aws/commands"
...
func main() {
	...
	app.Flag("silent", "Keep silents").Envar("SAML2AWS_SILENT").BoolVar(&commonFlags.Silent)
	...
	cmdEksToken := app.Command("eks-token", "Produce token to get access to EKS cluster.")
